              ...
              <li v-for="item in cartList">
                <div class="cart-tab-1">
                  <div class="cart-item-check">
                    <a href="javascipt:;" class="checkbox-btn item-check-btn" :class="{'check':item.checked===1}" @click.prevent="editCart('checked',item)">
                  ...
                  <div class="cart-item-pic">
                    <img v-lazy="'/static/'+item.productImage" :title="item.productName" :alt="item.productName">
                  </div>
          ...
          <div class="cart-foot-inner">
            <div class="cart-foot-l">
              <div class="item-all-check">
                <a  @click.prevent="toggleCheckAll">
            ...
            <div class="cart-foot-r">
              ...
              <div class="btn-wrap">
                <a class="btn btn--red" :class="{'btn--dis':checkedCount==0}" @click="checkOut">确认</a>
              </div>
            </div>
          </div>
        </div>
                  ...
                  .then(data => {
                      if(data.status === '200') {
                          ...
                          for(let key in this.cartList){
                              if(this.cartList[key].productId === this.delItem.productId){
